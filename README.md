<p align="center">
	  <img src="https://github.com/leogaudin/tnt-sierraleone/blob/main/application/ios/application/Images.xcassets/AppIcon.appiconset/1024.png?raw=true" alt="TnT Logo" width="150" height="150">
</p>

# 🌐 **Track-and-Trace − Development and Maintenance Guide**

The TnT codebase is divided into two major folders, [**Web**](https://github.com/leogaudin/tnt-sierraleone/blob/main/web/) and [**Application**](https://github.com/leogaudin/tnt-sierraleone/blob/main/application/), respectively handling the web dashboard and API, and the mobile scanning application.

This paper provides an overview of the main and essential parts of this codebase.

# [**Web**](https://github.com/leogaudin/tnt-sierraleone/blob/main/web/)

## [**Client**](https://github.com/leogaudin/tnt-sierraleone/blob/main/web/client/)

The client folder stores the files for the front-end.

All further mentions of files are made using [`web/client/src`](https://github.com/leogaudin/tnt-sierraleone/blob/main/web/client/src/) as the working directory, and the associated subpart if applicable.

The entry-point of the client is [`App.jsx`](https://github.com/leogaudin/tnt-sierraleone/blob/main/web/client/src/App.jsx). It initialises the router for the Single Page Application with all its main pages.

### [**`components`**](https://github.com/leogaudin/tnt-sierraleone/blob/main/web/client/src/components/)
...
- [**`controls`**](https://github.com/leogaudin/tnt-sierraleone/blob/main/web/client/src/components/controls/) : components that are meant to interact with others and manipulate external data.
- [**`customisation`**](https://github.com/leogaudin/tnt-sierraleone/blob/main/web/client/src/components/customisation/) : components serving only an aesthetic purpose.
- [**`insights`**](https://github.com/leogaudin/tnt-sierraleone/blob/main/web/client/src/components/insights/) : components delivering a visualization of internal data of some kind.
- [**`reusable`**](https://github.com/leogaudin/tnt-sierraleone/blob/main/web/client/src/components/reusable/) : complex component bases that are likely to be reused several times across the codebase.
...
### [**`constants`**](https://github.com/leogaudin/tnt-sierraleone/blob/main/web/client/src/constants/)

The constants folder stores elements such as side navigation items, and the translation file in the language sub-folder.

### [**`pages`**](https://github.com/leogaudin/tnt-sierraleone/blob/main/web/client/src/pages/)
...
### [**`service`**](https://github.com/leogaudin/tnt-sierraleone/blob/main/web/client/src/service/)
...
### [**`context`**](https://github.com/leogaudin/tnt-sierraleone/blob/main/web/client/src/context/)
...
## [**Server**](https://github.com/leogaudin/tnt-sierraleone/blob/main/web/server/)

The server folder stores the files for the back-end/API.

It follows the **Model/Router/Controller** file structure.

### [**Models**](https://github.com/leogaudin/tnt-sierraleone/blob/main/web/server/models/)
...
### [**Routers**](https://github.com/leogaudin/tnt-sierraleone/blob/main/web/server/routes/)
...
### [**Controllers**](https://github.com/leogaudin/tnt-sierraleone/blob/main/web/server/controllers/)
...
#### [**`base`**](https://github.com/leogaudin/tnt-sierraleone/blob/main/web/server/controllers/base/)
...
### [**`index.js`**](https://github.com/leogaudin/tnt-sierraleone/blob/main/web/server/index.js)
...
# [**Application**](https://github.com/leogaudin/tnt-sierraleone/blob/main/application/)
...
## [**components**](https://github.com/leogaudin/tnt-sierraleone/blob/main/application/src/components/)
...
- [**`atoms`**](https://github.com/leogaudin/tnt-sierraleone/blob/main/application/src/components/atoms/) : basic components serving only one use (e.g. a button, an icon).
- [**`molecules`**](https://github.com/leogaudin/tnt-sierraleone/blob/main/application/src/components/molecules/) : groups of components that delivers functionality (e.g. a modal template, a popup).
- [**`organisms`**](https://github.com/leogaudin/tnt-sierraleone/blob/main/application/src/components/organisms/) : groups of components delivering a unique functionality (e.g. the "Send scan" modal).
- [**`views`**](https://github.com/leogaudin/tnt-sierraleone/blob/main/application/src/components/views/) : complex components that can be used on their own as a page displayed to the end-user.

## [**constants**](https://github.com/leogaudin/tnt-sierraleone/blob/main/application/src/constants/)
...
## [**context**](https://github.com/leogaudin/tnt-sierraleone/blob/main/application/src/context/)
...
1. Open [`ios/application.xcworkspace`](https://github.com/leogaudin/tnt-sierraleone/blob/main/application/ios/application.xcworkspace) in Xcode.
...
1. Open the terminal and navigate to [`android/`](https://github.com/leogaudin/tnt-sierraleone/blob/main/application/android/).
