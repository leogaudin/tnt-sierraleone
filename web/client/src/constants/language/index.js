...
i18n
	...
	.init({
		...
		resources: {
			...
			ar: {
				translation: {
					description: 'تتبعوا وتتبعون حزمكم بسهولة باستخدام تطبيقنا الويب المتقدم. ابقوا على اطلاع بأخر الأخبار حول حالة وموقع شحناتكم. تتبعون تقدم التسليم بسهولة وتحصلون على السكون النفسي بعلمكم أين توجد حزمكم فعليا.',
					home: 'الرئيسية',
					boxes: 'الحزم',
					scans: 'المسحات',
					export: 'تصدير',
					...
					confusing: 'مبهم',
					noscans: 'لا يوجد مسحات حتى الآن',
					uploadPrompt: 'رفع الحزم من قائمة توزيع',
					noBoxes: 'لم يتم العثور على أي حزم',
					deleteOptions: 'خيارات الحذف',
					select: 'اختر {{option}}',
					waitBoxesLoading: 'الرجاء الانتظار حتى تتم تحميل الحزم...',
					deleteBoxes: 'حذف الحزم',
					confirmDelete: 'هل أنت متأكد من أنك تريد المتابعة في عملية الحذف؟ لا يمكن إلغاء هذه العملية.',
					by: 'بواسطة {{item}}',
					exportOptions: 'خيارات التصدير',
					invalidEmail: 'يجب أن يكون البريد الإلكتروني صالحًا',
					emailRequired: 'مطلوب البريد الإلكتروني',
					passwordRequired: 'مطلوب كلمة المرور',
					invalidCredentials: 'اسم المستخدم أو كلمة المرور غير صحيحة',
					noAccountYet: "ليس لديك حسابًا حتى الآن؟",
					register: 'تسجيل',
					...
					boxSummary: 'ملخص الحزمة',
					deleteBox: 'حذف هذه الحزمة',
					...
					final: 'النهائي',
					search: 'بحث...',
					notScannedInThePast_one: 'لم يتم المسح في اليوم السابق',
					notScannedInThePast_other: 'لم يتم المسح في {{count}} أيام',
					thereAreXNeverScanned_one: 'هناك {{count}} حزمة لم تتم مسحها أبدًا.',
					thereAreXNeverScanned_other: 'هناك {{count}} حزم لم يتم مسحها أبدًا.',
					thereAreXDelivered_one: 'هناك {{count}} حزمة تم تسليمها بالفعل.',
					thereAreXDelivered_other: 'هناك {{count}} حزم تم تسليمها بالفعل.',
					itemsWillBeDeleted_one: 'سيتم حذف {{count}} عنصر.',
					itemsWillBeDeleted_other: 'سيتم حذف {{count}} عناصر.',
					itemsWillBeExported_one: 'سيتم تصدير {{count}} عنصر.',
					itemsWillBeExported_other: 'سيتم تصدير {{count}} عناصر.',
					secondsAgo_one: 'قبل {{count}} ثانية',
					secondsAgo_other: 'قبل {{count}} ثواني',
					minutesAgo_one: 'قبل {{count}} دقيقة',
					minutesAgo_other: 'قبل {{count}} دقائق',
					hoursAgo_one: 'قبل {{count}} ساعة',
					hoursAgo_other: 'قبل {{count}} ساعات',
					daysAgo_one: 'قبل {{count}} يوم',
					daysAgo_other: 'قبل {{count}} أيام',
					weeksAgo_one: 'قبل {{count}} أسبوع',
					weeksAgo_other: 'قبل {{count}} أسابيع',
					monthsAgo_one: 'قبل {{count}} شهر',
					monthsAgo_other: 'قبل {{count}} أشهر',
					yearsAgo_one: 'قبل {{count}} سنة',
					yearsAgo_other: 'قبل {{count}} سنوات',
					justNow: 'الآن',
					future: 'في المستقبل',
					yesterday: 'أمس',
					tomorrow: 'غدًا',
					...
					logout: 'تسجيل الخروج',
					drop: 'اسحب!',
					dragPrompt: 'انقر أو اسحب الملفات هنا للتحميل',
					supportedTypes: 'أنواع الملفات المدعومة',
					csvExplanation: 'يمكن الحصول على ملف CSV من أي برنامج جداول بيانات مثل Microsoft Excel أو Google Sheets أو Apple Numbers. يمكنك اختيار هذا التنسيق في خيارات التصدير.',
					longUpload: 'قد يستغرق التحميل وقتًا طويلاً للملفات الكبيرة (500+ عنصر)، يرجى الانتظار.',
					uploadFinished: 'انتهى التحميل!',
					close: 'إغلاق',
					summary: 'ملخص',
					boxCreated: 'تم إنشاء الحزمة رقم {{id}} بنجاح.',
					download: 'تحميل {{item}}',
					report: 'تقرير',
					username: 'اسم المستخدم',
					invalidUsername: 'اسم مستخدم غير صالح',
					usernameRequired: 'اسم المستخدم مطلوب',
					reportNotAvailableOnMobile: 'التقارير غير متوفرة على الهاتف المحمول. يرجى استخدام متصفح سطح المكتب للوصول إلى هذه الميزة.',
					scansPerDate: 'المسحات حسب التاريخ',
					progressFunnel: 'قمع التقدم',
					scannedAtLeastOnce: 'تم مسحها مرة واحدة على الأقل',
					total: 'الإجمالي',
					notAuthorized: 'ليس لديك صلاحية لعرض هذا المحتوى.',
					error: 'خطأ',
					insights: 'إحصائيات',
					yourInsightsAreCurrently: 'إحصائياتك حاليا',
					public: 'عامة',
					private: 'خاصة',
					make: 'جعل',
					copied: 'تم النسخ!',
					accessLink: 'رابط الوصول',
					neverScanned: 'لم يتم المسح أبدًا',
